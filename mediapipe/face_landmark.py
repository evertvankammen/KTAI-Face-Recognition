...
from picture_compare_landmark import LandmarkFaceRec
...
def get_detection_results(detection_results: FaceLandmarkerResult):
    for list in detection_results.face_landmarks:
        d, n = lmf.face_lowest_distances(list)
        print(d,n)
    print("---")

    #print(detection_results.facial_transformation_matrixes)
...
lmf.save_encodings_images(image_path)
...
while capture.isOpened():
    ...
    if ret:
        ...
        get_detection_results(detection_result)
