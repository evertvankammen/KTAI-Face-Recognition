...
frames, sampled, found_names_list_with_frame_number, counted = face_recognizer.process_video(desired_tolerance=0.70,
                                                                                                 desired_width=450,
                                                                                                 desired_model='hog',
                                                                                                 upsample_times=0,
...
with open(f'exp_set_from_movie_results_tolerance_70_upsample_0_internetpictures_desired_width_750.txt', 'w') as fp:
